...
def print_death_age(people_dict):
   for i in people_dict:
        ...
        age1 = info[2]
        age2= info[3]
        ageatdeath = age2 -age1
        print(name, ageatdeath)
...
def print_marriages(marriages_dict, people_dict):
    ...
    for i in marriages_dict:
       info = marriages_dict[i]
       name1 = info[0]
       name2= info[1]
       year = info[2]
       info1 = people_dict[name1]
       info2= people_dict[name2]
       name = info1[NAME_INDEX]
       names = info2[NAME_INDEX]
       ageatdeath1 = info1[DEATH_YEAR_INDEX] - info1[BIRTH_YEAR_INDEX]
       ageatdeath2 = info2[DEATH_YEAR_INDEX] - info2[BIRTH_YEAR_INDEX]
       print(f"{name, ageatdeath1}< {year} >{names, ageatdeath2}")
    pass
